			...
			<div class="container mx-auto flex justify-between items-center">
				...
				@auth
					<nav class="flex gap-4 items-center">
						<a href="{{ route('posts.create') }}" class="flex items-center gap-2 bg-white border p-2 text-gray-600 rounded text-sm uppercase font-bold cursor-pointer hover:bg-zinc-200">
